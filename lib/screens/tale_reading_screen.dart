      ...
      return Scaffold(
        ...
        body: Center(
          child: Padding(
            ...
            child: Text(_errorMessage ?? '동화를 불러오지 못했어요.',
  ...
  Widget _buildTabletPageContent(TalePage page) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Opacity(
          opacity: 1.0 - (_pageFlipAnim.value * 0.3),
          child: child,
        );
      },
      child: Row(
      ...
      children: [
       Row(
        ...
        if (page.highlightText != null &&
            page.highlightText!.trim().isNotEmpty) ...[
          ...
          Column(
            ...
            children: [
              Text(
                isLastPage
                    ? '이야기를 다 읽었나요?'
                    : '${_currentPageIndex + 1} / ${_taleBook!.totalPages} 페이지',
                style: const TextStyle(
                    fontSize: 13,
                    fontWeight: FontWeight.w600,
                    color: Color(0xFF3D2C8D)),
