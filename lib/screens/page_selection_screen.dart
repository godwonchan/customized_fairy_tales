...
class _PageSelectionScreenState extends State<PageSelectionScreen> {
  ...
  Widget _buildPagination() {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          GestureDetector(
            onTap: _currentGridPage > 0
                ? () => setState(() => _currentGridPage--)
                : null,
            child: Container(
              width: 32, height: 32,
              decoration: BoxDecoration(
          ...
          const SizedBox(width: 12),
          Text(
            '${_currentGridPage + 1} / $_totalGridPages',
            style: const TextStyle(
                fontSize: 13,
                fontWeight: FontWeight.w600,
                color: Color(0xFF3D2C8D)),
          ...
          const SizedBox(width: 12),
          GestureDetector(
            onTap: _currentGridPage < _totalGridPages - 1
                ? () => setState(() => _currentGridPage++)
                : null,
            child: Container(
              width: 32, height: 32,
              decoration: BoxDecoration(
                color: _currentGridPage < _totalGridPages - 1
                    ? Colors.white
                    : Colors.grey[100],
                borderRadius: BorderRadius.circular(8),
                border: Border.all(color: Colors.grey[200]!),
  ...
  Widget _buildBottomPreview(bool isTablet) {
    final selectedPage = _selectedPageIndex != null
        ? widget.taleBook.pages[_selectedPageIndex!]
        : null;
                  ...
                  if (selectedPage != null)
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            _getPageDescription(_selectedPageIndex!),
                            style: const TextStyle(
                                fontSize: 13,
                                fontWeight: FontWeight.w600,
                                color: Color(0xFF3D2C8D)),
                          ...
                          Text(
                            selectedPage.text.length > 30
                                ? '${selectedPage.text.substring(0, 30)}...'
                                : selectedPage.text,
                            style: TextStyle(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ...[
                      '한 번에 한 페이지(한 장면)만 선택할 수 있어요.',
                      '선택한 장면 이후의 이야기가 새롭게 바뀌어요.',
                      '원하지 않는 부분만 골라 바꿀 수 있어요!',
                    ].map((hint) => Padding(
              ...
              TextButton(
                ...
                child: Row(
                  children: const [
                    ...
                    Text('이전 단계로 돌아가기',
                        style: TextStyle(
                            fontSize: 13, color: Color(0xFF7E57C2))),
                  ],
                ),
              ),
            ],
